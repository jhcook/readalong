...
## Acceptance Criteria
- [x] **AC1**: Text is split into sentences using NLP rules.
- [x] **AC2**: Sentences are split into words with punctuation handling.
- [x] **AC3**: Tokenization works for English initially.
- [x] **AC4**: Tokenization output is stored for alignment.
